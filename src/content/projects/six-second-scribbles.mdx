...
A browser version of the card game 6 Second Scribbles, reproduced using AI in about 60 minutes. You get a category card showing 10 things to draw, 6 seconds per item, and the other players guess what you drew. Points go to correct guessers and the artist. Three difficulty levels: easy, medium and hard.
